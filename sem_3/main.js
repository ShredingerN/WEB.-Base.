...
// // которые ввел пользователь, вывод должен выглядеть так (пример): Результат сложения чисел 
// // 5 и 2 равен 7.
...
// сообщением “Вам хорошо живется?” и кнопками «ОК», «Отмена», 
// для чего необходимо использовать confirm.- При нажатии 
// на кнопку “ОК” вывести в диалоговом окне текст с сообщением 
// “Тогда мы идем к вам!”.- При нажатии на кнопку “Отмена” 
// вывести в диалоговом окне текст с сообщением 
// “Ну вы держитесь там!”.

// const questAnswer = confirm("Вам хорошо живется?");
// if (questAnswer) {
...
// Функция getMaxEvenElement принимает массив с 
// целыми числами, необходимо реализовать функцию 
// так, чтобы она возвращала значение большего 
// элемента массива, который записан в четном 
// индексе включая 0.
